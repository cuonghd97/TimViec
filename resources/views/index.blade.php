            ...
            <div class="rows">
                <div class="col-md-9">
                    <div class="cate-title " style="float:left" id="home-title"><a href="/kenh-rss"><i class="fa fa-rss fa-fw"></i></a>
                        Chuyên mục rao vặt <span class="hidden-xs" id="home-city-name"></span></div>
                    ...
                    <div class="cate-icons rows " id="cateicons">
                        ...
                        <div class='cate-group main-cate-icon'><a href='/C-78-Doi-song-Xa-hoi' class='reload'>
                                <div class='fa fa-smile-o fa-3x' aria-hidden='true'></div>
                                <div class='cate-name'>Đời sống - Xã hội</div>
                            </a></div>
                        <div class='cate-group main-cate-icon'><a href='/C-76-O-to-Xe-may' class='reload'>
                                <div class='fa fa-car fa-3x' aria-hidden='true'></div>
                                <div class='cate-name'>Ô tô - Xe máy</div>
                            </a></div>
                        <div class='cate-group main-cate-icon'><a href='/C-10-May-tinh-Linh-kien' class='reload'>
                                <div class='fa fa-laptop fa-3x' aria-hidden='true'></div>
                                <div class='cate-name'>Máy tính - Linh kiện</div>
                            </a></div>
                        <div class='cate-group main-cate-icon'><a href='/C-9-Dich-vu' class='reload'>
                                <div class='fa fa-whatsapp fa-3x' aria-hidden='true'></div>
                                <div class='cate-name'>Dịch vụ</div>
                            </a></div>
                        <div class='cate-group main-cate-icon'><a href='/C-74-Kinh-doanh' class='reload'>
                                <div class='fa fa-balance-scale fa-3x' aria-hidden='true'></div>
                                <div class='cate-name'>Kinh doanh</div>
                            </a></div>
                        <div class='cate-group main-cate-icon'><a href='/C-82-Hang-hoa-Vat-lieu' class='reload'>
                                <div class='fa fa-tags fa-3x' aria-hidden='true'></div>
                                <div class='cate-name'>Hàng hóa - Vật liệu</div>
                            </a></div>
                        <div class='cate-group main-cate-icon'><a href='/C-98-Cong-nghe-thong-tin' class='reload'>
                                <div class='fa fa-globe fa-3x' aria-hidden='true'></div>
                                <div class='cate-name'>Công nghệ thông tin</div>
                            </a></div>
                        <div class='cate-group main-cate-icon'><a href='/C-3-Dien-thoai-Phu-kien' class='reload'>
                                <div class='fa fa-mobile fa-3x' aria-hidden='true'></div>
                                <div class='cate-name'>Điện thoại - Phụ kiện</div>
                            </a></div>
                        <div class='cate-group main-cate-icon'><a href='/C-84-My-thuat-Thiet-ke' class='reload'>
                                <div class='fa fa-paint-brush fa-3x' aria-hidden='true'></div>
                                <div class='cate-name'>Mỹ thuật - Thiết kế</div>
                            </a></div>
                        <div class='cate-group main-cate-icon'><a href='/C-1-Am-thuc-Thuc-pham' class='reload'>
