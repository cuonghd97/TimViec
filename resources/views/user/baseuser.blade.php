            ...
            <div class="col-md-3 col-sm-5">
                <div id="sidebar" class="panel panel-default hidden-xs">
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li class="list-menu"><a href="/quan-ly"><i class="fa fa-wpforms fa-fw"></i> Chỉnh sửa bản tin</a></li>
                        <li class="list-menu"><a href="{{ route('dangtin') }}"><i class="fa fa-commenting fa-fw"></i> Đăng tin rao vặt</a></li>
